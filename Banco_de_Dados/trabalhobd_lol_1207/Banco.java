...
//Importando as classes externas:
...
public class Banco {
    ...
    public static Connection getConnection(){
        if(connection == null){
            try{
                ...
                String pass = "<censurado>";//digitar a senha do seu banco
    ...
    public static void insertIntoCampeao(Campeao campeao){
        try{
            ...
            PreparedStatement ps = con.prepareStatement("INSERT INTO campeao (codCamp, nomeCamp,"
                    + " habilidades, classeCamp, codHist, codRota) values(?, ?, ?, ?, ?, ?)");
    ...
    public static void insertIntoHistoria(Historia historia){
        try{
            Connection con = Banco.getConnection();
            PreparedStatement ps = con.prepareStatement("INSERT INTO historia (codHist, titulo,"
                    + " raca, regiao) values(?, ?, ?, ?)");
    ...
    public static void insertIntoRota(Rota rota){
        try{
            Connection con = Banco.getConnection();
            PreparedStatement ps = con.prepareStatement("INSERT INTO rota (codRota, nomeRota,"
                    + " qtdTorres) values(?, ?, ?)");
